...
//				usart_appEventCallback(usartHandle, USART_EVENT_TX_CMPLT);
				usartHandle->appEventCallback(usartHandle, USART_EVENT_TX_CMPLT);
			}
		}
	}
...
//				usart_appEventCallback(usartHandle, USART_EVENT_RX_CMPLT);
				usartHandle->appEventCallback(usartHandle, USART_EVENT_RX_CMPLT);
			}
		}
	}
	...
	temp3 = IS_BIT_SET(usartHandle->usart->CR3, USART_CR3_CTSIE);	(void) temp3;
...
//		usart_appEventCallback(usartHandle, USART_EVENT_CTS);
		usartHandle->appEventCallback(usartHandle, USART_EVENT_CTS);
	}
...
//		usart_appEventCallback(usartHandle, USART_EVENT_IDLE);
		usartHandle->appEventCallback(usartHandle, USART_EVENT_IDLE);
	}
...
//		usart_appEventCallback(usartHandle, USART_EVENT_ORE);
		usartHandle->appEventCallback(usartHandle, USART_EVENT_ORE);
	}
...
//			usart_appEventCallback(usartHandle, USART_ERREVENT_FE);
			usartHandle->appEventCallback(usartHandle, USART_ERREVENT_FE);
		}
...
//			usart_appEventCallback(usartHandle, USART_ERREVENT_NE);
			usartHandle->appEventCallback(usartHandle, USART_ERREVENT_NE);
		}

		if (temp1 & (1 << USART_SR_ORE)) {
//			usart_appEventCallback(usartHandle, USART_ERREVENT_ORE);
			usartHandle->appEventCallback(usartHandle, USART_ERREVENT_ORE);
		}
	}
